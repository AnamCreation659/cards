export default function Navbar() {
  return (
    <div className="bg-[#040C15] h-[174px]">
      <div className="max-w-[1920px]">
   <div className="w-full py-6 px-12 flex items-center justify-between gap-2 bg-[#17263A] h-[60px] [clip-path:polygon(0_0,100%_0,100%_calc(100%-60px),calc(100%-50px)_100%,50px_100%,0_calc(100%-60px))] overflow-hidden">
          <span className="text-white font-xs font-bold font-grifter">
            COD PK (Under 12 Only)
          </span>
          <span className="flex items-center gap-1 text-[#90A7CB] border-l-2 border-[#90A7CB]">
            <svg
          ...
          <span className="flex items-center gap-1 font-sm text-[#90A7CB] border-l-2 border-[#90A7CB]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
          ...
          <span className="relative flex items-center gap-2 text-white font-bold text-lg">
            <span className="before:content-['/'] before:text-xl before:mr-2 before:text-white">
              Counter Strike GO
            </span>
          </span>
          <span className="flex items-center gap-1 font-sm text-[#90A7CB] border-l-2 border-[#90A7CB]">
          ...
          <span className="pl-2 font-sm font-bold text-white border-l-2 border-[#90A7CB]">
            COD PK (Under 12 Only)
          </span>{" "}
          <span className="flex items-center gap-1 font-sm text-[#90A7CB] border-l-2 border-[#90A7CB]">
            <svg
      ...
      {/* Bottom Section */}
      <div className="px-10 flex items-center justify-between h-[114px]">
  {/* Left Logo */}
  <div className="flex items-center gap-3">
    <img src="/image/aeu 1.png" alt="Logo" className="h-10 w-28" />
  </div>

  {/* Right Profile */}
  <div className="rounded-full border-[#FE0102] border-4 flex items-center justify-center">
    <img
      src="/image/aeu 1.png"
      alt="Right Logo"
